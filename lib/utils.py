...
# class EarlyStopping:
#     """
#     اگر loss اعتبارسنجی پس از تعداد مشخصی اپک (patience) بهبود پیدا نکند،
#     آموزش را متوقف کرده و بهترین مدل را ذخیره می‌کند.
#     """
#     def __init__(self, patience=7, verbose=False, delta=0, path='checkpoint.pt'):
#         """
#         Args:
#             patience (int): تعداد اپک‌هایی که برای بهبود loss صبر می‌کند.
#             verbose (bool): اگر True باشد، پیغام‌ها را چاپ می‌کند.
#             delta (float): حداقل تغییر در loss که به عنوان بهبود در نظر گرفته می‌شود.
#             path (str): مسیر فایل برای ذخیره بهترین مدل.
#         """
#         self.patience = patience
...
#         """بهترین مدل را در صورت بهبود loss ذخیره می‌کند."""
#         if self.verbose:
